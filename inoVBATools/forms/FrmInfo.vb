...
Public NotInheritable Class FrmInfo
    ...
    Private Sub FrmInfo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End If
        Me.Text = String.Format(My.Resources.ResourceLang.InfoTitle, ApplicationTitle)
        ...
        Me.LabelVersion.Text = String.Format(My.Resources.ResourceLang.InfoVersion, GetApplicationVersion)
        Me.LabelCopyright.Text = String.Format("{0} {1}", My.Resources.ResourceLang.InfoCopyright, IIf(Year(Now) = 2025, Year(Now), "2025 - " & Year(Now)))
        Me.LabelCompanyName.Text = My.Application.Info.CompanyName
        Me.TextBoxDescription.Text = My.Application.Info.Description
        OKButton.Text = My.Resources.ResourceLang.BtnOK
    End Sub
